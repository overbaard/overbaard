...
export class BoardIssueViewUtil {
  ...
  static createBoardIssue(issue: BoardIssue, jiraUrl: string, projectColour: string, ownStateName: string, visible: boolean, totalHeight: number): BoardIssueViewRecord {
