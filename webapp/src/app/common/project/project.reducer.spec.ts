...
describe('Projects reducer tests', () => {
  ...
  describe('Deserialization tests', () => {
    ...
    it('Deserialize', () => {
      const projectState: ProjectState = projectReducer(initialProjectState, ProjectActions.createDeserializeProjects(input));
    ...
    it('Deserialize same', () => {
      const projectStateA: ProjectState = projectReducer(initialProjectState, ProjectActions.createDeserializeProjects(input));
      const projectStateB: ProjectState = projectReducer(projectStateA, ProjectActions.createDeserializeProjects(input));
