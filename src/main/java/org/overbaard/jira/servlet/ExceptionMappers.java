...
public class ExceptionMappers {
    @Provider
    public static class OverbaardPermissionExceptionMapper implements ExceptionMapper<OverbaardPermissionException> {
        @Override
        public Response toResponse(OverbaardPermissionException e) {
            return getErrorResponse(Response.Status.FORBIDDEN, e, "Permission violation");
        }
    }

    @Provider
    public static class OverbaardValidationExceptionMapper implements ExceptionMapper<OverbaardValidationException> {
        @Override
        public Response toResponse(OverbaardValidationException e) {
